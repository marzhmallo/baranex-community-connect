            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
              <div className="flex items-center space-x-3 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <h1 className="text-lg sm:text-2xl font-bold text-white truncate">Activity Logs</h1>
                  <p className="text-primary-foreground/80 text-xs sm:text-sm truncate">Track all user activities and system events</p>
                </div>
              </div>
