      ...
      <div className="flex h-full flex-col">
        ...
        <nav className="flex-1 space-y-1 p-2">
          ...
          >
            ...
            {!isCollapsed && <span className="ml-2">Hub</span>}
          </Link>
          ...
          >
            ...
            {!isCollapsed && <span className="ml-2">Request Documents</span>}
          </Link>
          ...
          >
            ...
            {!isCollapsed && <span className="ml-2">Community Forum</span>}
          </Link>
          ...
          >
            ...
            {!isCollapsed && <span className="ml-2">Services</span>}
          </Link>
        </nav>
