      ...
      <div className="mb-8">
        ...
        <div className="md:hidden space-y-4">
          {isLoading ? (
            ...
            <div 
              key={request.id} 
              className="bg-white dark:bg-card rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden max-w-lg ml-0 mr-auto"
            >
              <div className="p-4">
                {/* Card Header */}
