...
const UserDocumentsPage = () => {
  ...
  return <div className="w-full p-4 md:p-6 bg-gradient-to-br from-background via-background to-muted/20 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-6 overflow-x-scroll pb-4 md:grid md:grid-cols-5 md:overflow-visible scrollbar-thin scrollbar-thumb-muted scrollbar-track-background scroll-smooth">
          <div className="flex-shrink-0 w-[200px] md:min-w-0 group cursor-pointer transition-all duration-300 hover:scale-105">
