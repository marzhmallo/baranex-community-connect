            ...
            <div className="p-0 flex-1 overflow-y-auto">
              <div className="relative">
                ...
                <div className="p-4 relative z-10 space-y-4">
                  ...
                  <div className="grid grid-cols-[auto_1fr] gap-3">
                    <div className="mt-1">
                      <div className="h-5 w-5 rounded-full bg-red-500 border-4 border-white shadow"></div>
                    </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-primary-700">#BRG-2023-0042</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-900">Barangay Clearance</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">Maria Santos</td>
                  ...
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">Today, 10:45 AM</td>
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-primary-700">#BRG-2023-0041</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-900">Certificate of Residency</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">Juan Dela Cruz</td>
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div className="flex items-center">
                  ...
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">Today, 9:20 AM</td>
                  <td className="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end gap-1">
                      <button className="p-1 text-gray-400 hover:text-primary-600 hover:bg-primary-50 rounded transition-colors">
                        <Eye className="h-4 w-4" />
                ...
                <tr className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-primary-700">#BRG-2023-0040</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-900">Business Permit</td>
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600">Anna Reyes</td>
                  <td className="px-4 py-3 whitespace-nowrap">
                    <div className="flex items-center">
                  ...
                  <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-500">Yesterday, 4:30 PM</td>
                  <td className="px-4 py-3 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex justify-end gap-1">
                      <button className="p-1 text-gray-400 hover:text-primary-600 hover:bg-primary-50 rounded transition-colors">
                        <Eye className="h-4 w-4" />
