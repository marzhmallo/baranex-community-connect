...
const DocumentsPage = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 bg-background min-h-screen space-y-4">
      <div className="mb-4">
      ...
      <div className="bg-card rounded-lg shadow-sm border col-span-full">
        <div className="p-4 border-b border-border">
          <h2 className="text-lg font-semibold text-foreground flex items-center gap-2">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-input rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent w-full sm:w-64 bg-background text-foreground"
              />
            </div>
            <div className="flex flex-wrap gap-2">
