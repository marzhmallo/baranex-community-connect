...
const issueDocumentSchema = z.object({
  ...
  resident_id: z.string().uuid({ message: "Please select a resident" }),
  purpose: z.string().min(5, { message: "Purpose must be at least 5 characters" }),
  payment_amount: z.coerce.number().min(0, { message: "Payment amount cannot be negative" }),
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      {selectedDocType?.description && (
                        <FormDescription>{selectedDocType.description}</FormDescription>
                      )}
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {Object.entries(selectedDocType.required_fields).map(([field, type]) => (
